...
1. **Scheduled Time** (e.g., 8 AM daily)
   ...
   - Integrated with NetGeniusClaw heartbeat system
...
```
Good morning John, this is your NetGeniusClaw daily briefing.
...
The daily briefing integrates with NetGeniusClaw's heartbeat system:
