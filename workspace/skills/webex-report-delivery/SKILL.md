...
NetGeniusClaw can deliver reports on a schedule when asked:

| Report | Suggested Cadence | Space |
|--------|------------------|-------|
| Fleet health check | Daily 06:00 UTC | NetGeniusClaw Reports |
| Security audit | Weekly (Monday) | NetGeniusClaw Reports |
| NetBox reconciliation | Weekly (Wednesday) | NetGeniusClaw Reports |
| Vulnerability scan | Monthly (1st) | NetGeniusClaw Reports |
| Topology validation | Monthly (15th) | NetGeniusClaw Reports |
