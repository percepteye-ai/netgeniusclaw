...
```ini
[Unit]
Description=NetGeniusClaw mesh daemon (BGP + NCFED eN2N + iN2N Border) — durable, feature 056/057
...
```ini
[Unit]
Description=NetGeniusClaw iN2N member <member_id> — durable, feature 057
