# Tasks: Ollama Domain Expert Delegation MCP (NetGeniusClaw Demo Edition)

**Input**: Design documents from `/specs/037-ollama-domain-experts/`

**Focus**: Specifically tuned for the NetGeniusClaw SP core demo's failure modes — GraphQL construction, BGP extra_attributes, FRR config generation from SOT data, and Nautobot job patterns.
...
## Phase 7: Integration with NetGeniusClaw
