...
**Tester:** NetGeniusClaw (automated)
...
The MCP server requires Bearer token authentication, while the direct REST API accepts X-API-Token header. NetGeniusClaw configuration handles this via the `IPFABRIC_AUTH_HEADER` environment variable.
...
*Tests performed by NetGeniusClaw automated validation on 2026-06-19*
