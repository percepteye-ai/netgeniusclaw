...
**Question**: How to handle inbound calls where John calls NetGeniusClaw?
...
**Rationale**:
- Already configured in NetGeniusClaw with API key
...
**Question**: Which TTS service to use for NetGeniusClaw voice responses?
...
```xml
<Response>
  <Say voice="Polly.Matthew">Hello John, this is NetGeniusClaw.</Say>
</Response>
```
...
- Twilio Functions: Limited to Twilio's runtime, can't access NetGeniusClaw tools
