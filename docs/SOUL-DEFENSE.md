# SOUL-DEFENSE: Security Principles for NetGeniusClaw

This document extends the [NetGeniusClaw SOUL](../SOUL.md) with detailed security principles and compliance guidance for DefenseClaw-protected deployments.
...
- Requires network path from NetGeniusClaw host to IP Fabric appliance
...
- [SOUL.md](../SOUL.md) - Core NetGeniusClaw principles (P18-P25 are security)
