...
**Goal**: Guidance documents encode the four-source hierarchy so NetGeniusClaw affirmatively knows it has a knowledge base and what belongs to Memory vs RAG vs live MCP (FR-032/033/047, GP-1/GP-7)
...
**Checkpoint**: NetGeniusClaw's guidance stack knows the knowledge base exists and what it is NOT
