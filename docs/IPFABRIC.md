...
> Production-grade integration of IP Fabric's network assurance platform into NetGeniusClaw via the official IP Fabric MCP Server.

**Developed in collaboration with Daren Fulwell (Field CTO, IP Fabric) and John Capobianco (Creator, NetGeniusClaw)** — representing nearly a decade of professional partnership.
...
3. **Network Connectivity** from NetGeniusClaw host to IP Fabric over HTTPS (port 443)
...
### New NetGeniusClaw Users

During the NetGeniusClaw installation process, you'll be prompted to enable IP Fabric:
...
IP Fabric data can be combined with other NetGeniusClaw skills:
...
- **John Capobianco** — Creator, NetGeniusClaw
