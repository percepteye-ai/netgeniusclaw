...
A FastMCP server providing gNMI (gRPC Network Management Interface) operations as MCP tools for NetGeniusClaw. Supports multi-vendor devices (Cisco IOS-XR, Juniper, Arista, Nokia SR OS) through OpenConfig and vendor-native YANG models.
