...
NetGeniusClaw uses a WebEx Bot access token for all messaging operations:
...
|-------|---------|-------------|
| NetGeniusClaw Alerts | Critical/High alerts only | Device down, security critical |
| NetGeniusClaw Reports | Scheduled reports | Health checks, audits, reconciliation |
| NetGeniusClaw Changes | Change notifications | Config changes, CR updates |
| NetGeniusClaw General | General interaction | Ad-hoc queries, help |
