...
Defines the schema for `netshell/policies/base.yaml` - the root sandbox policy that establishes default security controls for all NetGeniusClaw operations.
