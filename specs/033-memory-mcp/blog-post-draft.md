# NetGeniusClaw Now Remembers: Introducing the Memory MCP Server

**TL;DR**: NetGeniusClaw can now remember facts about your network, recall past troubleshooting sessions, audit decisions, and track entity relationships — all persisted locally and available across sessions.
...
The Memory MCP Server brings persistent, structured memory to NetGeniusClaw. It's not just a chat history — it's a hybrid storage system designed specifically for network operations:
...
With persistent memory, NetGeniusClaw can now:
...
- **Team memory sharing**: Export/import knowledge bases between NetGeniusClaw instances

---

## Try It Today

The Memory MCP Server is available now in NetGeniusClaw. Enable it, start recording facts, and watch your network assistant get smarter with every session.
