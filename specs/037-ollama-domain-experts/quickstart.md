...
Get domain-specific local models working with NetGeniusClaw in under 5 minutes.

## Prerequisites

- Ollama running on your AI host (`http://192.168.30.50:11434`) ✅ Already confirmed
- Python 3.11+ with the netgeniusclaw venv
...
## Step 5: Add to NetGeniusClaw Config
