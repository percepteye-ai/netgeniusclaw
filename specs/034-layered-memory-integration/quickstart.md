...
NetGeniusClaw now has a two-tier memory system that works like a human brain:
...
**During your session**, NetGeniusClaw automatically:
...
Session Start
├── GAIT: branch created
├── NetGeniusClaw queries memory for mentioned entities
│
├── You: Check BGP status on PE2
│   └── NetGeniusClaw: memory_record_fact entity="pe2" key="bgp_state" value="established"
│       GAIT: memory_record_fact: pe2/bgp_state
│
├── You: PE2 peers with RR1, right?
│   └── NetGeniusClaw: memory_link_entities subject="pe2" predicate="peers_with" object="rr1"
│       GAIT: memory_link_entities: pe2 peers_with rr1
│
├── You: Increase the hold timer to 180s
│   └── NetGeniusClaw: memory_record_decision
...
│
Session End
├── NetGeniusClaw: memory_store_session
...
NetGeniusClaw: [Records fact to Memory MCP]
...
NetGeniusClaw: [Performs semantic search]
...
NetGeniusClaw: [Creates link]

You: What would be affected if we take down PE2?

NetGeniusClaw: [Queries graph]
