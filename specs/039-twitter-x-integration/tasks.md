...
**Goal**: NetGeniusClaw automatically tweets every 4 hours with CCIE-level network insights

**Independent Test**: Configure heartbeat interval, wait for scheduled tweet trigger, verify tweet appears with #netgeniusclaw hashtag
...
**Goal**: Users can ask NetGeniusClaw to tweet specific content with guardrails

**Independent Test**: Tell NetGeniusClaw "tweet about BGP path selection", verify tweet is posted with CCIE voice and #netgeniusclaw
...
**Goal**: NetGeniusClaw uses persistent memory to generate authentic, personalized tweets from actual experiences
