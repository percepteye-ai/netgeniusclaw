  ...
  "body": [
    ...
    },
    {
      ...
      "facts": [
        ...
        { "title": "Reporter:", "value": "NetGeniusClaw (automated)" }
      ]
    },
    {
      "type": "TextBlock",
...
**NetGeniusClaw:** Automated investigation assistant
...
NetGeniusClaw runs diagnostics and posts results as threaded replies:
...
| P2 | IC + Team | 30 min | NetGeniusClaw Alerts |
| P3 | Assigned engineer | 4 hours | NetGeniusClaw Alerts |
| P4 | Queue only | Next business day | NetGeniusClaw General |
...
These actions are received via WebEx Webhooks (`attachmentActions` resource) and processed by NetGeniusClaw to update the incident state.
