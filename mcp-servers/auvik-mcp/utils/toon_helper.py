"""TOON / GCF serialization shim for Auvik MCP server.

Mirrors azure-network-mcp/utils/gcf_helper.py: attempts to use the
netclaw_tokens GCF serializer for token-efficient output; falls back to
standard json.dumps if the optional package is unavailable.
"""
