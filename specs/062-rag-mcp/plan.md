...
**Project Type**: MCP server + skill/docs + HUD extension (NetGeniusClaw capability addition per Constitution XI)
...
*GATE: evaluated against NetGeniusClaw Constitution v1.2.0 — PASS (pre-research and post-design). No violations to justify; Complexity Tracking left empty.*
