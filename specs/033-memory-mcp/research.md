...
**Decision**: Package as uvx-installable Python package, consistent with other NetGeniusClaw MCP servers.

**Rationale**:
- Consistent with existing NetGeniusClaw MCP servers (IP Fabric, GNS3, SuzieQ)
...
- Snap/Flatpak: Less common in NetGeniusClaw ecosystem
...
Following existing NetGeniusClaw MCP servers:
