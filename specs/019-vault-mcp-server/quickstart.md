...
```bash
vault policy write netgeniusclaw netclaw-policy.hcl
vault token create -policy=netgeniusclaw -ttl=24h
```
...
**IMPORTANT**: Secret values are NEVER displayed in NetGeniusClaw output.
