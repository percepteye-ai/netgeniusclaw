...
2. **NetGeniusClaw Environment**
   - Python 3.10+
   - NetGeniusClaw workspace configured
...
- **OS**: Windows 10/11 (UE Editor), WSL2 (NetGeniusClaw) or native Linux
...
### Step 5: Configure NetGeniusClaw
...
If running NetGeniusClaw in WSL2 and UE5 on Windows:
...
```python
# Remove all netgeniusclaw actors
response = httpx.post(url, json={
    "jsonrpc": "2.0",
    "method": "tools/call",
    "params": {
