...
**Purpose**: Quick invocation to check mentions and respond to #netgeniusclaw threads.

**Trigger**: `/twitter-check` or "check twitter" or "#netgeniusclaw check"
...
2. **Filter**: Find unprocessed mentions in #netgeniusclaw threads
