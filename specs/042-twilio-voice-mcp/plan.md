...
Add bidirectional phone call capabilities to NetGeniusClaw for emergency alerts, situation updates, daily check-ins, on-demand calls, AND the ability to call NetGeniusClaw for voice conversations. Uses official @twilio-alpha/mcp NPM package for outbound calls, custom webhook handler for inbound calls with STT/TTS, and strict guardrails for call safety.
