...
2. Start NetGeniusClaw and attempt dangerous operation:
   ```
...
**Goal**: Verify NetGeniusClaw works without DefenseClaw.
...
2. Start NetGeniusClaw:
   ```bash
   openclaw gateway
   ```

3. **Expected Result**: NetGeniusClaw starts normally without security prompts
...
### Pass Criteria
- [ ] NetGeniusClaw runs without DefenseClaw
