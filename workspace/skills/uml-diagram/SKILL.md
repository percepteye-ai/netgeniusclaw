...
@startuml
actor Engineer
participant NetGeniusClaw
participant ServiceNow
participant Device
participant GAIT

Engineer -> NetGeniusClaw : "Add Loopback99"
NetGeniusClaw -> ServiceNow : Create Change Request
ServiceNow --> NetGeniusClaw : CR-12345 (New)
NetGeniusClaw -> ServiceNow : Wait for approval
ServiceNow --> NetGeniusClaw : CR-12345 (Implement)
NetGeniusClaw -> Device : Capture baseline
Device --> NetGeniusClaw : Running config
NetGeniusClaw -> Device : Apply config
Device --> NetGeniusClaw : Config applied
NetGeniusClaw -> Device : Verify change
Device --> NetGeniusClaw : Loopback99 up/up
NetGeniusClaw -> ServiceNow : Close CR-12345
NetGeniusClaw -> GAIT : Record full audit trail
NetGeniusClaw --> Engineer : Done. Verified.
@enduml
""",
  output_format="svg"
)
...
workspace {
  model {
    ...
    netgeniusclaw = softwareSystem "NetGeniusClaw" {
