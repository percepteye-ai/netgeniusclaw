...
Integrate the official PagerDuty MCP server to provide incident management capabilities within NetGeniusClaw. This closes the loop on the ServiceNow CR workflow by enabling direct incident creation, escalation, and resolution.
...
**As a** network engineer using NetGeniusClaw
...
**I want to** create a PagerDuty incident from NetGeniusClaw
...
3. Integration appears in NetGeniusClaw UI with correct tool count
