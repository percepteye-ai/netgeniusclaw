...
Elevate the existing NetGeniusClaw Mesh (eBGP over ngrok, bgp-daemon-v2) from route
...
**Target Platform**: Linux/WSL2 host running the NetGeniusClaw stack (same as mesh)
