...
Ask NetGeniusClaw to check for mentions:
...
'auto-cost reference-bandwidth 10000' for 10G environments. #netgeniusclaw"
...
NetGeniusClaw: Found 3 new mentions:
...
3. @cisco_fan (1 hr ago): "@John_Capobianco love NetGeniusClaw! Can it generate
   topology diagrams?"
...
NetGeniusClaw: Here's my suggested reply:
...
Common culprits: AS mismatch, source IP, eBGP multihop. #netgeniusclaw"

Post this reply? [Yes/No/Edit]

User: "Yes"

NetGeniusClaw: Reply posted: https://twitter.com/i/web/status/123456789
```
