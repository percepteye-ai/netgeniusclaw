...
Lightweight, GCF-friendly dataclasses defined in `mcp-servers/claroty-mcp/models/responses.py`. These project the subset of xDome attributes a NetGeniusClaw operator typically wants; raw dicts pass through alongside the projected model when a tool needs to expose untyped fields.
