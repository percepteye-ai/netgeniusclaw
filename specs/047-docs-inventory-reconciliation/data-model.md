...
**Represents**: One documented operational capability exposed to the NetGeniusClaw agent.
...
**Represents**: One distinct, individually-usable MCP server NetGeniusClaw supports.
