...
**Goal**: Provide clear upgrade path for existing NetGeniusClaw users to enable DefenseClaw
...
**Independent Test**: Decline DefenseClaw during install, NetGeniusClaw runs normally
...
**Checkpoint**: Users can decline security and still use NetGeniusClaw
