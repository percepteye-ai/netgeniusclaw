...
**New NetGeniusClaw installation:**
```bash
./scripts/install.sh
...
- **NetGeniusClaw Skill:** workspace/skills/checkpoint/SKILL.md
...
For NetGeniusClaw integration issues, open an issue at https://github.com/automateyournetwork/netclaw/issues
