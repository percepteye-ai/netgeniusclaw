...
This research consolidates the verified counts and integration details needed to update NetGeniusClaw documentation. All values have been validated against the codebase.
...
**Rationale**:
- "skills" is the established term in NetGeniusClaw
