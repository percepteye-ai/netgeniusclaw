...
#   Standalone NetGeniusClaw or part of a risk?          → part of a risk
...
Choosing **Standalone NetGeniusClaw** at install → behaves exactly as today (a risk of one, its own Border). `n2n_risk_status()` reports `standalone`; nothing about members or routing is imposed.
