...
- Consistent with community MCP server patterns in NetGeniusClaw
...
- Aligns with NetGeniusClaw's operational focus
...
- Standard pattern for NetGeniusClaw MCP servers
