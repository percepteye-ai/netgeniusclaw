...
4. Network connectivity from NetGeniusClaw host to switch management IPs
...
```text
# Natural language request to NetGeniusClaw:
...
After installation, verify all 4 skills appear in NetGeniusClaw:
