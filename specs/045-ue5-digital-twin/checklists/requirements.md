...
- Protocol/integration nouns (SNMP, gNMI, pyATS, PagerDuty, NetBox, Infrahub) are treated as domain vocabulary for a network engineering tool, consistent with how `010-telemetry-receivers/spec.md` (an existing, accepted spec in this repo) names protocols and NetGeniusClaw's own integrations directly — not as implementation-detail leakage.
