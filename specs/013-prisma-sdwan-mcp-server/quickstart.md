...
5. **Restart NetGeniusClaw** to load the new MCP server.
...
**Given** NetGeniusClaw is connected to Prisma SD-WAN
...
3. Integrate with existing NetGeniusClaw workflows (packet capture handoff, etc.)
