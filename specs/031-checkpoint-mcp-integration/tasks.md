...
**⚠️ IMPORTANT**: NetGeniusClaw pattern is to git clone MCP repos into `mcp-servers/` folder (46+ existing cloned repos). We must clone https://github.com/CheckPointSW/mcp-servers, NOT use npx.
...
**Goal**: Enable frictionless onboarding for both new and existing NetGeniusClaw users
...
**Goal**: Engineers can correlate Check Point policies with other NetGeniusClaw data sources
...
- **Git clone into mcp-servers/checkpoint-mcp-servers/** - follows NetGeniusClaw pattern (46+ existing cloned repos)
