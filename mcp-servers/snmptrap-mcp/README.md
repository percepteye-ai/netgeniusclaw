...
snmp-server user netgeniusclaw NETGENIUSCLAW v3 auth sha AuthPass priv aes 128 PrivPass
snmp-server host 10.0.0.1 version 3 priv netgeniusclaw
snmp-server enable traps
```
...
Part of the NetGeniusClaw project.
