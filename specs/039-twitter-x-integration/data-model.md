...
Represents an outgoing tweet posted by NetGeniusClaw.

| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `tweet_id` | string | Yes | Twitter's unique identifier for the tweet |
| `content` | string | Yes | Tweet text content (≤280 chars) |
| `hashtags` | string[] | Yes | Extracted hashtags (always includes #netgeniusclaw) |
...
- `hashtags` must always include "#netgeniusclaw"
