...
Integrate the official Splunk MCP server to provide log aggregation and SPL query capabilities within NetGeniusClaw. This integrates with existing syslog-receiver skills and enables powerful log analysis for network troubleshooting.
...
**I want to** search Splunk logs using SPL from NetGeniusClaw
