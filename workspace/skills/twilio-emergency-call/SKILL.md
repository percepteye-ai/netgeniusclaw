...
Action:
  ...
  3. Voice message: "NetGeniusClaw Emergency Alert. PagerDuty Priority 1 Incident. Database primary node unresponsive."
...
```
Input:
  - NetGeniusClaw monitoring detects
...
Action:
  ...
  2. Call initiated to [WHITELIST_NUMBER]
  3. Voice message: "NetGeniusClaw Emergency Alert. Core device failure detected. CHI-CORE-02 is down."
```
