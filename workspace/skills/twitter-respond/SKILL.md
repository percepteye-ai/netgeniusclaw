...
- **netclaw_request** - Questions about NetGeniusClaw automation, diagrams, skills
...
3. @cisco_fan: "@John_Capobianco can NetGeniusClaw generate topology diagrams?"
...
Common issues: AS mismatch, source IP, eBGP multihop. #netgeniusclaw"
...
- **twitter-share** - Share NetGeniusClaw outputs to Twitter (feature 039)
