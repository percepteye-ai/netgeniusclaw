...
This guide helps existing NetGeniusClaw users enable DefenseClaw enterprise security.
...
### Before (Hobby Mode)
- NetGeniusClaw runs without security layer
- Full host access
...
- NetGeniusClaw Issues: https://github.com/automateyournetwork/netclaw/issues
