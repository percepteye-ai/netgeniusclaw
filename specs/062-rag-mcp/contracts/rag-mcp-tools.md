...
**Params**: `file_path: str` (required) · `doc_type: str = "other"` (`vendor|standard|customer|install-guide|other`) · `title: str|null` · `version: str|null` · `source: str|null` (override, e.g. `slack:#netgeniusclaw`)
