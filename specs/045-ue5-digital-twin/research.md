...
**Alternatives considered**: Source-of-truth-only (rejected — makes the story unusable for the common unlabeled-lab case) and manual-only (rejected — ignores real placement data NetGeniusClaw already has access to via existing integrations).
