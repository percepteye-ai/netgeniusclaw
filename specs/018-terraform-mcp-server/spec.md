...
Integrate the official HashiCorp Terraform MCP server to provide Infrastructure as Code (IaC) capabilities within NetGeniusClaw. This enables GitOps workflows for network infrastructure provisioning and management.
...
**I want to** manage workspaces from NetGeniusClaw
