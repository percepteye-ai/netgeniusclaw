...
4. **NetGeniusClaw** installed and running
...
2. Create or select your Project (e.g., "NetGeniusClaw")
...
Ask NetGeniusClaw to post a test tweet:

```
"Tweet: Testing NetGeniusClaw's new Twitter integration! #netgeniusclaw"
```
...
NetGeniusClaw will automatically tweet every 4 hours with:
