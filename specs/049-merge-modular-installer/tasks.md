...
- Every new catalog entry and install function must match `contracts/catalog-entry-format.md` exactly, since the whole point of this exercise is that the merged installer reads as one coherent system, not "PR #96's style" plus "NetGeniusClaw's bolted-on style"
